...
function onCreatedNavigationTarget(a) {
  if (!(0 < a.frameId || -1 == a.tabId) && !monitorInfo.isDetecting()) {
    ...
    if (b.parent instanceof WindowNode) {
      ...
      c ? c.windowId != b.windowId ? log("Not moving because opener and opened tabs are in different windows", c.windowId, b.windowId, c, b, a) : (log("Moving page to be child of its sourceTabId", a.tabId, a.sourceTabId, a), tree.moveNode(b, ["chromeId", a.sourceTabId]), tree.conformChromeTabIndexForPageNode(b, !0, !1, !0)) : log("Not moving because could not find sourceTabId " + a.sourceTabId)
