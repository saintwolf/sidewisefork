...
(function(b) {
  ...
  b.extend(b.jgrid, {
    ...
    getAccessor: function(b, e) {
      ...
      c = b[e];
      if (void 0 === c) try {
        if ("string" === typeof e && (a = e.split(".")), h = a.length)
          for (c = b; c && h--;) d = a.shift(), c = c[d]
      } catch (g) {}
      return c
    },
      ...
      return new function(e, c) {
        ...
        this._doSort = function(a, b) {
          ...
          for (h = 0; h < c.length; h++)
            for (var e = d._doSort(c[h].items, b), g = 0; g < e.length; g++) f.push(e[g]);
          return f
        };
        ...
        this.startsWith = function(a, c) {
          var h = void 0 === c || null === c ? a : c,
            h = f ? b.trim(h.toString()).length :
            h.toString().length;
        ...
        this.endsWith = function(a, c) {
          var h = void 0 === c || null === c ? a : c,
            h = f ? b.trim(h.toString()).length : h.toString().length;
      ...
      if (!this.grid) {
        ...
        if ("TABLE" != this.tagName.toUpperCase()) alert("Element is not a table");
          ...
          if (0 === this.p.colNames.length)
            for (e = 0; e < this.p.colModel.length; e++) this.p.colNames[e] =
          ...
          if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
            ...
            var o = function(a, b) {
              ...
              p = function(d, e, f, g, i, j) {
                ...
                if (e === 0) y = y + ("width: " + c.headers[d].width + "px;");
                  ...
                  if ((d = K.cellattr.call(a, i, f, g, K, j)) && typeof d === "string") {
              ...
              J = function(c, d, e, f, g) {
                var h = "-1",
                  ...
                  f = b.isFunction(a.p.rowattr) ? a.p.rowattr.call(a,
                    f, g) : {};
              ...
              $ = function(c, d, e, f, g) {
                var h = new Date,
                  i = a.p.datatype !=
                  "local" && a.p.loadonce || a.p.datatype == "xmlstring",
                  j = a.p.xmlReader,
              ...
              aa = function(c, d, e, f, g) {
                ...
                if (c) {
                  ...
                  var k = 0,
                    l, B, q = [],
                    m, s = a.p.multiselect ? 1 : 0,
                    o = a.p.subGrid ? 1 : 0,
                    p = a.p.rownumbers === true ? 1 : 0,
                    n, u, t = {},
                    v, r, w = [],
                    C = a.p.altRows === true ? " " + a.p.altclass : "",
                    A;
                  ...
                  var x = parseInt(a.p.rowNum, 10),
                    D = a.p.scroll ? b.jgrid.randId() : 1;
                  g && (x =
                    x * (g + 1));
              ...
              ma = function() {
                ...
                if (b.isArray(a.p.data)) {
                  ...
                  b.each(a.p.colModel, function() {
                    ...
                    if (a.p.grouping) {
                      q = 0;
                      for (m = l.groupField.length; q < m; q++)
                        if (this.name == l.groupField[q]) {
                          var c = this.name;
                  ...
                  if (a.p.treeGrid) b(a).jqGrid("SortTree", d, a.p.sortorder, f[d].stype, f[d].srcfmt);
                    ...
                    if (a.p.grouping)
                      for (q = 0; q < m; q++) s.orderBy(h[q], l.groupOrder[q], g[q].stype, g[q].srcfmt);
            ...
            var ja = function(c, e, d, f) {
              ...
              oa = function(c) {
                var e, d = {},
                  f = b.jgrid.cellWidth() ? 0 : a.p.cellLayout;
            ...
            this.p.multiselect && (this.p.colNames.unshift("<input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/>"), this.p.colModel.unshift({
              name: "cb",
              width: b.jgrid.cellWidth() ? a.p.multiselectWidth + a.p.cellLayout : a.p.multiselectWidth,
              sortable: !1,
              resizable: !1,
              hidedlg: !0,
              search: !1,
            ...
            (function() {
              var d = 0,
                e = b.jgrid.cellWidth() ? 0 : o(a.p.cellLayout, 0),
                f = 0,
                g, i = o(a.p.scrollOffset, 0),
                j, k = false,
                l, m = 0,
                n = 0,
                p;
              ...
              if (b(d.target).closest("th>span.ui-jqgrid-resize").length == 1) {
                ...
                if (a.p.forceFit === true) {
                  var f = a.p,
                    g = e,
                    i;
                  for (i = e + 1; i < a.p.colModel.length; i++)
            ...
            var Y = null,
              j = b("<table class='ui-jqgrid-htable' style='width:" +
                a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(x),
            ...
            b(a).before(c.hDiv).click(function(c) {
              ...
              var d = b(A).hasClass("cbox"),
                e = b(a).triggerHandler("jqGridBeforeSelectRow", [n[0].id, c]);
              ...
              if (!(A.tagName == "A" || (A.tagName == "INPUT" || A.tagName == "TEXTAREA" || A.tagName == "OPTION" || A.tagName ==
                ...
                if (a.p.cellEdit === true)
                  if (a.p.multiselect && d) b(a).jqGrid("setSelection", t, true, c);
                  else {
                    t = n[0].rowIndex;
                    try {
                  ...
                  if (c[a.p.multikey]) b(a).jqGrid("setSelection", t, true, c);
                  else {
  ...
  b.jgrid.extend({
      ...
      this.each(function() {
        ...
        for (; h < a;) d && (j = g.rows[h]), b(j).hasClass("jqgrow") && (b('td[role="gridcell"]', j).each(function(a) {
          ...
          if ("cb" !== i && "subgrid" !== i && "rn" !== i)
            if (!0 === g.p.treeGrid && i == g.p.ExpandColumn) e[i] = b.jgrid.htmlDecode(b("span:first", this).html());
            else try {
              e[i] = b.unformat.call(g, this, {
                  rowId: j.id,
        ...
        if (e) try {
          if (b(this.p.colModel).each(function(a) {
              ...
              void 0 !== e[d] && (k[d] = this.formatter && "string" === typeof this.formatter && "date" == this.formatter ?
                b.unformat.date.call(g, e[d], this) : e[d], i = g.formatter(f, e[d], a, e, "edit"), h = this.title ? {
                  title: b.jgrid.stripHtml(i)
                } : {}, !0 === g.p.treeGrid && d == g.p.ExpandColumn ? b("td:eq(" + a + ") > span:first", j).html(i).attr(h) : b("td:eq(" + a + ")", j).html(i).attr(h))
            }), "local" == g.p.datatype) {
            var m = b.jgrid.stripPref(g.p.idPrefix, f),
              o = g.p._index[m];
            if (g.p.treeGrid)
              for (var p in g.p.treeReader) k.hasOwnProperty(g.p.treeReader[p]) && delete k[g.p.treeReader[p]];
    ...
    footerData: function(f, e, c) {
      ...
      this.each(function() {
        ...
        b(this.p.colModel).each(function(d) {
          a = this.name;
          "set" == f ? void 0 !== e[a] && (l = c ? j.formatter("", e[a], d, e, "edit") : e[a], i = this.title ? {
            title: b.jgrid.stripHtml(l)
          } : {}, b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html(l).attr(i), h = !0) : "get" == f && (g[a] = b("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html())
        })
      });
      return "get" == f ? g : h
    },
    showHideCol: function(f,
      e) {
      return this.each(function() {
        var c = this,
          d = !1,
          a = b.jgrid.cellWidth() ? 0 : c.p.cellLayout,
          h;
        if (c.grid) {
          "string" === typeof f && (f = [f]);
          e = "none" != e ? "" : "none";
          var g = "" === e ? !0 : !1,
            i = c.p.groupHeader && ("object" === typeof c.p.groupHeader || b.isFunction(c.p.groupHeader));
    ...
    setGridWidth: function(f,
      e) {
      return this.each(function() {
        if (this.grid) {
          var c = this,
            d, a = 0,
            h = b.jgrid.cellWidth() ? 0 : c.p.cellLayout,
            g, i = 0,
            j = !1,
            l = c.p.scrollOffset,
            k, m = 0,
    ...
    setCell: function(f, e, c, d, a, h) {
      return this.each(function() {
        ...
        if (this.grid && (isNaN(e) ? b(this.p.colModel).each(function(a) {
          ...
          var l = b("td:eq(" + g + ")", i);
          if ("" !== c || !0 === h) i = this.formatter(f, c, g, i, "edit"), j = this.p.colModel[g].title ? {
            title: b.jgrid.stripHtml(i)
          } : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(l)).length ? b("span", b(l)).html(i).attr(j) : b(l).html(i).attr(j), "local" == this.p.datatype && (i = this.p.colModel[g], c = i.formatter && "string" === typeof i.formatter && "date" == i.formatter ? b.unformat.date.call(this, c, i) : c, j = this.p._index[f], "undefined" != typeof j && (this.p.data[j][i.name] =
            c));
            ...
            for (; m < k;) {
              if (b(this.rows[m]).hasClass("jqgrow")) {
                ...
                c ? (j = parseFloat(a), h += j, 0 ===
                  m ? i = g = j : (g = Math.min(g, j), i = Math.max(i, j))) : e ? d.push({
                  id: this.rows[m].id,
                  value: a
                }) : d.push(a)
              }
      ...
      return this.each(function() {
        ...
        b(c).keydown(function(d) {
          var a = b(c).find("tr[tabindex=0]")[0],
            f, g, i, j = c.p.treeReader.expanded_field;
          if (a)
            if (i = c.p._index[a.id], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
              if (38 === d.keyCode) {
                g = a.previousSibling;
                f = "";
                if (g)
...
(function(c) {
  ...
  c.fn.fmatter.select = function(a, b) {
    ...
    if (f) {
      ...
      if (c.fmatter.isString(f))
        for (var j = f.split(g), k = 0, l = 0; l < j.length; l++)
          if (g = j[l].split(e), 2 < g.length && (g[1] = c.map(g, function(a, b) {
              if (b > 0) return a
  ...
  c.unformat.select = function(a, b, f, d) {
    ...
    a = c(a).text();
    if (!0 === d) return a;
    var d = c.extend({}, !c.fmatter.isUndefined(b.colModel.formatoptions) ? b.colModel.formatoptions : b.colModel.editoptions),
    ...
    if (d.value) {
      ...
      if (c.fmatter.isString(g))
        for (var i = g.split(e), j = 0, k = 0; k < i.length; k++)
          if (e = i[k].split(b), 2 < e.length && (e[1] = c.map(e, function(a, b) {
              if (b > 0) return a
  ...
  a.extend(a.jgrid, {
        ...
        case "custom":
          ...
          try {
            if (a.isFunction(b.custom_element))
              if (m = b.custom_element.call(l, c, b)) m = a(m).addClass("customelement").attr({
                id: b.id,
                name: b.name
              }), a(e).empty().append(m);
              else throw "e2";
    ...
    checkValues: function(d, b, c, f, g) {
      ...
      if (h) {
        ...
        if (!0 === h.email && !(!1 === f && a.jgrid.isEmpty(d)) && (g = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, !g.test(d))) return [!1, i + ": " + a.jgrid.edit.msg.email, ""];
        ...
        if (e.grid) {
          ...
          if (null !== a("#" + a.jgrid.jqID(t.themodal)).html()) d(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
            ...
            var n = a.extend([], e.p.colModel),
              ...
              b = "<a href='javascript:void(0)' id='" + l + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" +
              c.Reset + "</a>",
              m = "",
              h = "",
              k, j = !1,
      ...
      return this.each(function() {
        ...
        function r(d, e, h) {
          ...
          if ("_empty" == d) a(m).each(function() {
            ...
            if ((f = a("#" + a.jgrid.jqID(i), "#" + h)) && f.length && null !== f[0])
              if (o = "", k.defaultValue ?
        ...
        function s() {
          var e, f = [!0, "", ""],
            g = {},
            q = b.p.prmNames,
            k, l, n, p, v, u = a(b).triggerHandler("jqGridAddEditBeforeCheckValues", [a("#" + h), z]);
          ...
          for (n in i)
            if (i.hasOwnProperty(n) && (f = a.jgrid.checkValues.call(b, i[n], n, b), !1 === f[0])) break;
          t();
          ...
          if (f[0] && !c[b.p.id].processing) {
            ...
            if (!0 === b.p.treeGrid)
              for (v in i[l] == q.addoper && (p = a(b).jqGrid("getGridParam", "selrow"), i["adjacency" == b.p.treeGridModel ? b.p.treeReader.parent_id_field : "parent_id"] = p), b.p.treeReader) b.p.treeReader.hasOwnProperty(v) &&
                ...
                if (f[0] === false) {
                  ...
                  if (c[b.p.id].checkOnSubmit || c[b.p.id].checkOnUpdate) {
                    ...
                    if (c[b.p.id]._savedData[b.p.id + "_id"] !=
                      "_empty")
                      for (var v in c[b.p.id]._savedData) i[v] && (c[b.p.id]._savedData[v] = i[v])
                  }
                }
            ...
            f[0] && (c[b.p.id].useDataProxy ? (g = b.p.dataProxy.call(b, v, "set_" + b.p.id), "undefined" == typeof g && (g = [!0, ""]), !1 === g[0] ?
              (f[0] = !1, f[1] = g[1] || "Error deleting the selected row!") : (v.data.oper == q.addoper && c[b.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(o.themodal), {
                gb: "#gbox_" + a.jgrid.jqID(m),
                jqm: d.jqModal,
                onClose: c[b.p.id].onClose
        ...
        function f() {
          if ("_empty" !== u && "undefined" !== typeof b.p.savedRow && 0 < b.p.savedRow.length && a.isFunction(a.fn.jqGrid.restoreRow))
            for (var d = 0; d < b.p.savedRow.length; d++)
              if (b.p.savedRow[d].id == u) {
        ...
        if (b.grid && u) {
          ...
          if (null !== a("#" + a.jgrid.jqID(o.themodal)).html()) {
            ...
            var q = "<a href='javascript:void(0)' id='" + q + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
              ...
              k = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + k + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" +
              (x ? D + q : q + D) + "</td><td class='EditButton'>" + J + K + "</td></tr>" + ("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + c[b.p.id].bottominfo + "</td></tr>"),
              k = k + "</tbody></table>";
            if (0 < H) {
              var L = [];
      ...
      return this.each(function() {
        ...
        function r(b, c) {
          ...
          if (h = a(c).jqGrid("getInd", b, !0)) a("td", h).each(function(b) {
            ...
            "cb" !== d && ("subgrid" !== d && "rn" !== d) && (g = d == c.p.ExpandColumn && !0 === c.p.treeGrid ? a(this).text() : a(this).html(), a.extend({}, c.p.colModel[b].editoptions || {}), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + n).html(g), e && a("#" + d, "#" + n).parents("tr:first").hide(), f++)
          }), 0 < f && a("#id_g", "#" + n).val(b)
        }
            ...
            a("#dData", "#" + f + "_2").click(function() {
              ...
              if (g[0] && !c[e.p.id].processing) {
                ...
                j = a.extend({
                  ...
                  type: c[e.p.id].mtype,
                  data: a.isFunction(c[e.p.id].serializeDelData) ?
                    c[e.p.id].serializeDelData.call(e, n) : n,
                    ...
                    if (g[0] === false) {
                      ...
                      if (c[e.p.id].reloadAfterSubmit && e.p.datatype != "local") a(e).trigger("reloadGrid");
                        ...
                        if (e.p.treeGrid === true) try {
                          ...
                          for (var l = 0; l < h.length; l++) a(e).jqGrid("delRowData", e.p.idPrefix + h[l]);
                        e.p.selrow = null;
                        e.p.selarrrow = []
                      }
        ...
        if (!this.nav) {
          ...
          if (g.grid && "string" == typeof c) {
            null === a("#" + p.themodal).html() && (!d.alerttop && !d.alertleft && ("undefined" != typeof window.innerWidth ? (d.alertleft = window.innerWidth, d.alerttop = window.innerHeight) : "undefined" != typeof document.documentElement && "undefined" != typeof document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (d.alertleft = document.documentElement.clientWidth,
              d.alerttop = document.documentElement.clientHeight) : (d.alertleft = 1024, d.alerttop = 768), d.alertleft = d.alertleft / 2 - parseInt(d.alertwidth, 10) / 2, d.alerttop = d.alerttop / 2 - 25), a.jgrid.createModal(p, "<div>" + d.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
            ...
            for (var w = 0; w < n; w++) {
              ...
              d.add && (l = l || {}, f = a("<td class='ui-pg-button ui-corner-all'></td>"), a(f).append("<div class='ui-pg-div'><span class='ui-icon " +
                d.addicon + "'></span>" + d.addtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                title: d.addtitle || "",
                id: l.id || "add_" + h
              }).click(function() {
              ...
              d.edit && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " +
                  d.editicon + "'></span>" + d.edittext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                  title: d.edittitle || "",
                  id: e.id || "edit_" + h
                }).click(function() {
                ...
                f = null);
              d.view && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), s = s || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.viewicon + "'></span>" + d.viewtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                title: d.viewtitle || "",
                id: s.id || "view_" + h
              }).click(function() {
                if (!a(this).hasClass("ui-state-disabled")) {
              ...
              d.del && (f = a("<td class='ui-pg-button ui-corner-all'></td>"), r = r || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.delicon + "'></span>" + d.deltext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                title: d.deltitle || "",
                id: r.id || "del_" + h
              }).click(function() {
                if (!a(this).hasClass("ui-state-disabled")) {
                  ...
                  if (b) a.isFunction(d.delfunc) ?
                    d.delfunc.call(g, b) : a(g).jqGrid("delGridRow", b, r);
                  else {
                    a.jgrid.viewModal("#" + p.themodal, {
                      gbox: "#gbox_" + a.jgrid.jqID(g.p.id),
                      jqm: true
              ...
              d.search && (f = a("<td class='ui-pg-button ui-corner-all'></td>"),
                t = t || {}, a(f).append("<div class='ui-pg-div'><span class='ui-icon " + d.searchicon + "'></span>" + d.searchtext + "</div>"), a("tr", b).append(f), a(f, b).attr({
                  title: d.searchtitle || "",
                  id: t.id || "search_" + h
                }).click(function() {
    ...
    GridToForm: function(c, d) {
      return this.each(function() {
        ...
        if (e.grid) {
          ...
          if (l)
            for (var r in l) a("[name=" + a.jgrid.jqID(r) + "]", d).is("input:radio") || a("[name=" + a.jgrid.jqID(r) + "]", d).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(r) + "]", d).each(function() {
              if (a(this).val() ==
...
(function(a) {
  ...
  a.jgrid.extend({
    editRow: function(c, b, d, k, g, l, p, h, f) {
      var j = {},
        e = a.makeArray(arguments).slice(1);
      if ("object" === a.type(e[0])) j = e[0];
      else if ("undefined" !== typeof b && (j.keys = b), a.isFunction(d) && (j.oneditfunc = d), a.isFunction(k) && (j.successfunc = k), "undefined" !== typeof g && (j.url = g), "undefined" !== typeof l && (j.extraparam = l), a.isFunction(p) && (j.aftersavefunc = p), a.isFunction(h) && (j.errorfunc = h), a.isFunction(f)) j.afterrestorefunc = f;
      j = a.extend(!0, {
        keys: !1,
        oneditfunc: null,
        successfunc: null,
      ...
      return this.each(function() {
        ...
        b.grid && (m = a(b).jqGrid("getInd", c, !0), !1 !== m && (e = a(m).attr("editable") || "0", "0" == e && !a(m).hasClass("not-editable-row") && (n = b.p.colModel, a('td[role="gridcell"]', m).each(function(e) {
          ...
          if ("cb" != f && ("subgrid" != f && "rn" != f) && (b.p.autoencode && (d = a.jgrid.htmlDecode(d)), l[f] = d, !0 === n[e].editable)) {
            ...
            var k = a.extend({}, n[e].editoptions || {}, {
              id: c + "_" + f,
              name: f
            });
    ...
    saveRow: function(c, b, d, k, g, l, p) {
      ...
      if ("1" === h) {
        ...
        if ("clientArray" == f.url) {
          ...
          a(q).attr("editable", "0");
          for (h = 0; h < e.p.savedRow.length; h++)
            if (e.p.savedRow[h].id == c) {
              t = h;
              break
            }
          ...
          j = !0;
          a(q).unbind("keydown")
        } else a("#lui_" + a.jgrid.jqID(e.p.id)).show(), r = a.extend({}, i, r), r[n] = a.jgrid.stripPref(e.p.idPrefix, r[n]), a.ajax(a.extend({
          url: f.url,
          data: a.isFunction(e.p.serializeRowData) ? e.p.serializeRowData.call(e,
            r) : r,
          type: f.mtype,
          async: !1,
          complete: function(b, d) {
            ...
            if (d === "success") {
              ...
              if (g === true) {
                ...
                a(q).attr("editable", "0");
                for (g = 0; g < e.p.savedRow.length; g++)
                  if (e.p.savedRow[g].id ==
                    c) {
                    t = g;
                    break
                  }
          ...
          error: function(b, d, g) {
            a("#lui_" + a.jgrid.jqID(e.p.id)).hide();
            a(e).triggerHandler("jqGridInlineErrorSaveRow", [c, b, d, g, f]);
            if (a.isFunction(f.errorfunc)) f.errorfunc.call(e, c, b, d, g);
            else try {
    ...
    restoreRow: function(c, b) {
      ...
      return this.each(function() {
        ...
        if (b.grid) {
          ...
          if (p !== false) {
            for (var f = 0; f < b.p.savedRow.length; f++)
        ...
        if (this.grid) {
          ...
          if (!0 === b.addParams.useFormatter) {
            ...
            for (p = 0; p < l.length; p++)
              if (l[p].formatter && "actions" === l[p].formatter) {
                l[p].formatoptions && (l = a.extend({
                  ...
                  extraparam: {},
                  url: null
                }, l[p].formatoptions), b.addParams.addRowParams = {
                  keys: l.keys,
                  oneditfunc: l.onEdit,
          ...
          b.add && a(d).jqGrid("navButtonAdd", c, {
            caption: b.addtext,
            title: b.addtitle,
          ...
          b.edit && a(d).jqGrid("navButtonAdd", c, {
            caption: b.edittext,
            title: b.edittitle,
            ...
            onClickButton: function() {
              var c = a(d).jqGrid("getGridParam",
                "selrow");
              c ? (a(d).jqGrid("editRow", c, b.editParams), a("#" + g + "_ilsave").removeClass("ui-state-disabled"), a("#" + g + "_ilcancel").removeClass("ui-state-disabled"), a("#" + g + "_iladd").addClass("ui-state-disabled"), a("#" + g + "_iledit").addClass("ui-state-disabled")) : (a.jgrid.viewModal("#alertmod", {
                gbox: "#gbox_" + g,
                jqm: !0
              }), a("#jqg_alrt").focus())
            }
          });
          b.save && (a(d).jqGrid("navButtonAdd", c, {
            caption: b.savetext || "",
          ...
          b.cancel && (a(d).jqGrid("navButtonAdd", c, {
    ...
    template: function(a) {
      ...
      return a.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g, function(a, c) {
        if (isNaN(parseInt(c, 10))) {
          for (var b = d[e], g = b.length; g--;)
            if (c === b[g].nm) return b[g].v;
          e++
  ...
  b.jgrid.extend({
    groupingSetup: function() {
      return this.each(function() {
        ...
        if (null !== a && ("object" === typeof a || b.isFunction(a)))
          if (a.groupField.length) {
            ...
            a.summary = [];
            for (var d = this.p.colModel, e = 0, f = d.length; e < f; e++) d[e].summaryType && a.summary.push({
              nm: d[e].name,
              st: d[e].summaryType,
              v: "",
              sr: d[e].summaryRound,
              srt: d[e].summaryRoundType || "round"
            })
      ...
      this.each(function() {
        for (var c = this.p.groupingView, h = this, g = c.groupField.length, k, j, p = 0, i = 0; i < g; i++) k = c.groupField[i], j = e[k], void 0 !== j && (0 === f ?
          (c.groups.push({
            ...
            cnt: 1,
            summary: []
          }), c.lastvalues[i] = j, c.counters[i] = {
            cnt: 1,
            pos: c.groups.length - 1,
            summary: b.extend(!0, [], c.summary)
          }) : "object" !== typeof j && c.lastvalues[i] !== j ? (c.groups.push({
            idx: i,
            dataIndex: k,
            value: j,
            startRow: f,
            cnt: 1,
            summary: []
          }), c.lastvalues[i] = j, p = 1, c.counters[i] = {
            cnt: 1,
            pos: c.groups.length - 1,
            summary: b.extend(!0, [], c.summary)
          }) : 1 === p ? (c.groups.push({
            ...
            pos: c.groups.length -
              1,
            summary: b.extend(!0, [], c.summary)
          }) : (c.counters[i].cnt += 1, c.groups[c.counters[i].pos].cnt = c.counters[i].cnt), b.each(c.counters[i].summary, function() {
    ...
    groupingToggle: function(a) {
      this.each(function() {
        ...
        var e = e.join("_"),
          ...
          k = b("#" + b.jgrid.jqID(a) + " span.tree-wrap-" + this.p.direction),
          j = !1;
        if (k.hasClass(c)) {
          if (d.showSummaryOnHide) {
            if (g)
              for (; g && !b(g).hasClass("jqfoot");) b(g).hide(), g = g.nextSibling
          } else if (g)
            for (; g && !b(g).hasClass(e + "_" + ("" + f)) && !b(g).hasClass(e + "_" + ("" + (f - 1)));) b(g).hide(), g = g.nextSibling;
          k.removeClass(c).addClass(h);
          j = !0
        } else {
          if (g)
            for (; g && !b(g).hasClass(e + "_" + ("" + f)) && !b(g).hasClass(e + "_" + ("" + (f -
    ...
    groupingRender: function(a, d) {
      return this.each(function() {
        function e(a, c, b) {
          ...
          if (0 === d) return b[a];
          for (; 0 <= a; a--)
            if (b[a].idx === d - c) return b[a]
        }
        var f = this,
          c = f.p.groupingView,
          h = "",
          g = "",
          k, j, p = c.groupCollapse ? c.plusicon : c.minusicon,
          i, w = [],
          x = c.groupField.length,
          p = p + (" tree-wrap-" +
            f.p.direction);
        b.each(f.p.colModel, function(a, b) {
          for (var d = 0; d < x; d++)
            if (c.groupField[d] === b.name) {
              w[d] = a;
              break
            }
        });
    ...
    setTreeNode: function(a, c) {
      return this.each(function() {
        ...
        if (b.grid && b.p.treeGrid)
          for (var e = b.p.expColInd, g = b.p.treeReader.expanded_field, h = b.p.treeReader.leaf_field, f = b.p.treeReader.level_field, l = b.p.treeReader.icon_field, j = b.p.treeReader.loaded, i, p, m, k; a < c;) k = b.p.data[b.p._index[b.rows[a].id]], "nested" == b.p.treeGridModel && !k[h] && (i = parseInt(k[b.p.treeReader.left_field], 10), p = parseInt(k[b.p.treeReader.right_field], 10), k[h] = p === i + 1 ? "true" : "false", b.rows[a].cells[b.p._treeleafpos].innerHTML =
      ...
      return this.each(function() {
        ...
        if (this.grid && this.p.treeGrid) {
          ...
          if (void 0 !== l) {
            ...
            if (0 < l.length)
              for (var j = 0; j < l.length; j++) d(this).jqGrid("delRowData", l[j][c]);
            if ("nested" === this.p.treeGridModel) {
              ...
              if (c.length)
                for (f in c) c.hasOwnProperty(f) && (c[f][b] = parseInt(c[f][b], 10) - h);
              c = d.jgrid.from(this.p.data).greater(e, g, {
                stype: "integer"
              }).select();
              if (c.length)
                for (f in c) c.hasOwnProperty(f) && (c[f][e] = parseInt(c[f][e], 10) - h)
            }
          }
        }
      })
