...
(function(a) {
  ...
  a.extend(a.jgrid, {
    ...
    search: {
      ...
      Find: "Find",
      Reset: "Reset",
      odata: "equal;not equal;less;less or equal;greater;greater or equal;begins with;does not begin with;is in;is not in;ends with;does not end with;contains;does not contain".split(";"),
      groupOps: [{
        op: "AND",
        text: "all"
      }, {
